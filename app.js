...
var config = {
  ...
  recaptcha_sitekey: '6LeD8CETAAAAAOdJrep-KHqhm5kKWxMbgG_VxIX7',  // <----- EDIT ME!
  redirect_uri: 'http://geodice.xyz/',
        ...
        el.button(
          {
            ...
            className: 'btn btn-default btn-sm',
            onClick: this._onClick,
            style: { marginTop: '-5px',marginLeft:"10px",width:"120px"
...
var Footer = React.createClass({
  ...
  render: function() {
    return el.div(
      ...
      el.a(
        {
          href: 'https://www.moneypot.com/apps/1233-fundice'
        },
        'FunDice Gambling'
      )
    );
